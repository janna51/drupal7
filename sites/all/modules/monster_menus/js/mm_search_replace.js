...
MMSR_initialize = function (context, settings) {
  $('#rightcolumn')
  ...
  Drupal.behaviors.collapse.attach($('<fieldset id="mmsr-diagnostic" class="collapsible collapsed"><legend><span class="fieldset-legend">' + Drupal.settings.MMSR.t_query + '</span></legend><div class="fieldset-wrapper"><div id="mmsr-diagnostic-content"></div></div></fieldset>')
...
MMSR_fixup_perms_others = function () {
...
Drupal.behaviors.autocomplete = null;
