  ...
  <div id="page">
    ...
    <div id="bookmark">
        ...
        <a href="http://web.wellesley.edu/" class="a-img" >
            <img alt="Wellesley College" src="/sites/all/themes/Bluenog/images/w-logo.jpg">
        </a> 
    ...
    <div id="content-wrapper">
 			...
 			<div id="top-menu-wrap">
				...
				<ul id="top-menu">
					<li><a class="top-menu-about" href="/about">About Wellesley</a></li>
					<li><a class="top-menu-admission" href="/admission">Admission &amp; Financial Aid</a></li>
