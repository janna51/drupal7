...
?>
  ...
  <div id="global-navs">                
			<ul class="sf-menu">
			<li>
				<a href="/about" <?php print NoRightSidebar_active_menu('about') ?>>About</a>
            	<ul>
			...
			<li><a href="/admission" <?php print NoRightSidebar_active_menu('admission') ?>>Admission &amp; Financial Aid </a>
            	<ul>
			...
			<li><a href="/academics" <?php print NoRightSidebar_active_menu('academics') ?>>Academics</a>
				<ul>
            ...
            <li><a href="/studentlife" <?php print NoRightSidebar_active_menu('studentlife') ?>>Student Life</a>
				<ul>
    		...
    		<li><a href="/athletics" <?php print NoRightSidebar_active_menu('athletics') ?>>Athletics</a>
				<ul>
			...
			<li>
				<a href="/news" <?php print NoRightSidebar_active_menu('news') ?>>News</a>                
                <ul>
    		...
    		<li><a href="/events" <?php print NoRightSidebar_active_menu('events') ?>>Events</a>
				<ul>
			...
			<li>
				<a href="/administration" <?php print NoRightSidebar_active_menu('administration') ?>>Administration</a>                
                <ul>
        	...
        	<li>
				<a href="/alumnae" <?php print NoRightSidebar_active_menu('alumnae') ?>>Alumnae</a>                
                <ul>
...
<!--THE HIDE/SHOW FLOATING MENU CODE STARTS -->
 ...
 <div class="inner-bottom-menu">
        ...
        <div class="col">
        <img src="/sites/all/themes/NoRightSidebar/image/footer_logo.png" alt="Wellesley College logo" />        </div>
        <div class="col-middle">
            <ul>
         ...
         <div id="minimize_menu" ><img src="/sites/all/themes/NoRightSidebar/image/hide.png" alt="Hide" /></div>
	...
	<div id="min_bottom_menu"><!--THIS IS THE SMALL MINIMIZED bottom-menu-->
        <center>
          ...
          <div class="inner-bottom-menu">
            ...
            <div class="col">
                <img src="/sites/all/themes/NoRightSidebar/image/footer_logo.png" alt="Wellesley College logo" width="35px" />        
            </div>
          
            <div class="col-last">
                <ul>
                    <li> 
                        <img src="/sites/all/themes/NoRightSidebar/image/show.png" alt="Show" />
                    </li>
                </ul>
            </div>
         </div>  
