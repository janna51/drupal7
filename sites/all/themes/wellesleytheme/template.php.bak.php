...
function wellesleytheme_preprocess_html(&$vars) {
  $theme_path = drupal_get_path('theme', 'wellesleytheme');
  // Add CSS
...
function wellesleytheme_preprocess_page (&$vars) {
}

function wellesleytheme_preprocess_node (&$vars) {
  kpr($vars);
}