...
?>
  ...
  <div id="global-navs">                
		<ul class="sf-menu">
    		...
    		<li><a href="/athletics" <?php print Athletics_active_menu('athletics') ?>>Athletics</a>
				<ul>
...
<!--THE HIDE/SHOW FLOATING MENU CODE STARTS -->
 ...
 <div class="inner-bottom-menu">
        ...
        <div class="col">
        	<a href="/">
        		<img src="/sites/all/themes/Athletics/image/athletic_logo.png" width="120" alt="Wellesley College Athletics logo" />  
            </a>      
        </div>
        <div class="col-middle">
            <ul>
         ...
         <div id="minimize_menu" ><img src="/sites/all/themes/Athletics/image/hide.png" alt="Hide" /></div>
	...
	<div id="min_bottom_menu"><!--THIS IS THE SMALL MINIMIZED bottom-menu-->
        <center>
          ...
          <div class="inner-bottom-menu">
            ...
            <div class="col">
                <img src="/sites/all/themes/Athletics/image/footer_logo.png" alt="Wellesley College logo" width="35px" />        
            </div>
          
            <div class="col-last">
                <ul>
                    <li> 
                        <img src="/sites/all/themes/Athletics/image/show.png" alt="Show" />
                    </li>
                </ul>
            </div>
         </div>  
    ...
    (function ($){$('.reveal2').hide();
     ...
     $('.toggle2').click(function(){
      ...
      t.parent().find('.reveal2').toggle("fast", function(){
            ...
            var imgsrc = ($(this).is(':hidden')) ? '/sites/all/themes/Athletics/image/downarrow.png' : '/sites/all/themes/Athletics/image/uparrow.png';
            // update image src
            t.attr('src', imgsrc );      
        });
