...
function wellesleybluenog_preprocess_html(&$vars) {
  $theme_path = drupal_get_path('theme', 'wellesleybluenog');
  // Add CSS
...
function wellesleybluenog_preprocess_page (&$vars) {
}

function wellesleybluenog_preprocess_node (&$vars) {
  kpr($vars);
}