...
<!--THE HIDE/SHOW FLOATING MENU CODE STARTS -->
   ...
   <div class="inner-bottom-menu">
        ...
        <div class="col-middle">
         ...
         <div id="minimize_menu" ><img src="/sites/all/themes/President/image/hide.png" alt="Hide" /></div>
	...
	<div id="min_bottom_menu"><!--THIS IS THE SMALL MINIMIZED bottom-menu-->
        <center>
          ...
          <div class="inner-bottom-menu">
            ...
            <div class="col">
                <img src="/sites/all/themes/President/image/footer_logo.png" alt="Wellesley College logo" width="35px" />        
            </div>
          
            <div class="col-last">
                <ul>
                    <li> 
                        <img src="/sites/all/themes/President/image/show.png" alt="Show" />
                    </li>
                </ul>
            </div>
         </div>  
