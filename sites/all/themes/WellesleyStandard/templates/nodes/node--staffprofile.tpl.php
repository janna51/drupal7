  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      hide($content['links']);
		  ...
		  hide($content['field_profilejobtitle']);
	...
	print "<div class=\"profile-portrait\">";
		  ...
		  print $field_profileemail[0]['value']. "<br><br>\n";
		  print $field_profilephone[0]['value']. "<br>\n";
		  print $field_profiledept[0]['value']. "\n";
		 

      print "<br><hr><br></div>";

	    print "<span class=\"profile-name\">".$field_profilefirst[0]['value'] . " " . $field_profilelast[0]['value'] . "</span><br>\n";
		print" <span class=\"profile-position-title\">" . $field_profilejobtitle[0]['value'] . "</span><br><br>\n";
